...
export const NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID || "CA5OK6BWFRN67257RITZMLAY2YJ6T6FTU2ZM3UY76QYIE6DXB5QUAPMV";
export const NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID || "CA5BDN2A2FM5AR3FEOBPPUCEAJCNKPKRRQFSLZ66SP7LGDKVJEKRPYTK";
