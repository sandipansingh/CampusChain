...
export const NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID || "CD2LH66FJ4UWSKAFB3AD2I6WHKDZ4KGZIQCN47HW2Y3IYLCRJHLX5HAL";
export const NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID || "CBPX6MKVPO3WJWUS2RSN4CZPTH45GYMEEAXIOUZ6RA2RTBV42Y35WX5R";
