...
export const NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID || "CADNFSTOVRNFJGDLCL3MUYDABRR5EPPVY5QOWV6VY7XTIAPQDOSKG4M7";
export const NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID || "CBM4I26Z3Q47FQWU2BFF7ALYERMQALIRWGY47P63FCRT5CH6ZT35PSQ7";
