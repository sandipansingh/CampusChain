...
export const NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID || "CAKWHIJWM2PNGA2XPHGU3CWXHOASOYBFBOHWXLXBAXD777SPE4TIIVHN";
export const NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID || "CCP2Z6E7DSOUJRFZOPII6UYVVLLW65F2EIULLLVRAYF4LHDIEM2ZLIZH";
