      ...
      <div className="mx-auto max-w-7xl px-6 text-left sm:text-center">
        ...
        <div className="mb-12 flex flex-col gap-3 sm:mb-20 sm:flex-row sm:justify-center sm:gap-4">
          <button
            ...
            className="rounded-lg bg-zinc-950 px-8 py-4 text-center text-sm font-semibold tracking-[0.05em] text-white transition-all hover:bg-zinc-800 shadow-md cursor-pointer"
          >
            Get Started
          </button>
          <a href="#features" className="rounded-lg border border-zinc-200 px-8 py-4 text-center text-sm font-semibold tracking-[0.05em] text-zinc-950 transition-colors hover:bg-zinc-50">Learn More</a>
        </div>
