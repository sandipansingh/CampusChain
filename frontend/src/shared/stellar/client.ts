...
export const NEXT_PUBLIC_CAMPUS_IDENTITY_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_IDENTITY_CONTRACT_ID || "CARIZNHDFQU635QTQY7KK7N43D7YEQFUZDCEQC4IS6YBR7EMLHZVAW5E";
export const NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_TOKEN_CONTRACT_ID || "CD63BOFRQNCDR7FVVWYPOI5DASAMSIIR3O54EXMGGDNUMGEWAHMU5PA7";
export const NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID =
  process.env.NEXT_PUBLIC_CAMPUS_SERVICE_CONTRACT_ID || "CDCPGEB2VLSKXGKHOBNZKUH5XEHLQ2VVYDQ2CAOO4Q7S2PEQXTKPY257";
