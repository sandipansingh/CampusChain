...
- Deployed Testnet contract interfaces, fetched read-only with Stellar CLI:
  - `CampusIdentity`: `CAICTPPKS7JOWZMPK2UHTJAEXDYWNEXLDBFLAPFSZURKDCRNYUCRHCSR`
  - `CampusToken`: `CAODSL3PHLTCLATVT4FZWXNMSN6WVKZ4LLOSVLLE5OJSVAHAOG4UYEDZ`
  - `CampusService`: `CA4FLLDHACOF23QFI3CQILR44KJ6M6DXND77RUMAGCTRRG3KK4ZY7RJJ`
